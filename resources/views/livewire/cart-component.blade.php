                            ...
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action" data-title="Remove"><a href="#" class="text-muted" wire:click.prevent="destroy('{{$item->rowId}}')" onclick="myFunction()"><i class="fi-rs-trash"></i></a></td>
                                    </tr>
                                    @endforeach
...
<script>
 function myFunction() {
  ...
  if (confirm(text)) {
    // User pressed OK, perform deletion logic here
    deleteItem();
    text = "Item deleted!";
  } else {
